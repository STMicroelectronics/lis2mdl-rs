...
mod mode {
    ...
    pub use lis2mdl_rs::asynchronous as lis2mdl;
...
mod mode {
    ...
    pub use lis2mdl_rs::blocking as lis2mdl;
    pub use cortex_m_rt::interrupt;
}

pub use mode::*;
pub use lis2mdl::I2CAddress;
...
// hard-iron (with MAG offset)
#[cfg(feature = "hard_iron")]
mod examples {
    mod hard_iron;
    pub use hard_iron::run;
}
